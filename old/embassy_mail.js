          ...
          <tr>
            <td style="font-size:14px; line-height:1.6; text-align:left;">
              ...
              <ul style="padding-left:20px;">
                <li>Recognized importers or distributors in foreign country</li>
...
const msg = {
  from: {
    email: "info@gov.nkaglobalexports.com",
    name: "Ankit Kapoor | NKA GLOBAL EXPORTS"
  },
  replyTo: "info@nkaglobalexports.com",
  ...
  personalizations: [
    { to: [{ email: "info@ccmoz.org.mz" }] },
    { to: [{ email: "cta@cta.org.mz" }] },
    { to: [{ email: "udari@cta.org.mz" }] },
    { to: [{ email: "president@ibcmoz.com" }] },
  ]
};
