...
const subject = 'Exploring Long-Term Export Partnership Opportunity';
const from = {
  email: 'info@nkaglobalexports.com',
  name: 'NKA Global Exports'
};
const replyTo = 'contact@nkaglobalexports.com';


// Raw email list (as received)
const rawEmails = `
5augankit@gmail.com
ankit.kapoor1901@gmail.com
`;

// Convert to required format
const formattedEmails = rawEmails
  .split('\n')
...
module.exports = formattedEmails;

console.log(JSON.stringify(formattedEmails));
